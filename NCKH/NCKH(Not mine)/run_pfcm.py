...
from Phan_cum.PFCM import Dpfcm
from validity import print_metrics, print_info, SPLIT
...
if __name__ == "__main__":
    ...
    if DATA_ID in TEST_CASES:
        ...
        dpfcm = Dpfcm(C= n_cluster, a=A, b=B, eta=ETA, K=K, m=M, eps=epsilon, maxiter=MAX_ITER)
        test_points = _TEST['test_points']  
        U1, V1, step, T1 = dpfcm.fit(data=_dt['X'], init_v=init_V, seed=SEED)
        ...
        print('-' * 100)
        print_info('PFCM', _dt['X'], U1, V1, process_time, M, step)