...
def fetch_data_from_local(name_or_id=53, folder: str = '/home/dll/ncs/clustering/dataset', header: int = 0, index_col: list = None, usecols: list = None, nrows: int = None) -> dict:
